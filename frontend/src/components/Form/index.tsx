  ...
  return (
    <form className={styles.baseForm}>
      ...
      <div className={styles.inputsAreaOne}>
        ...
        />
        <InputOne placeHolder={"Digitar senha"} inputId="senha" label="senha" register={register("password")} />
      </div>
  ...
  return (
    <form className={styles.baseForm} onSubmit={handleSubmit(registerUser)}>
      ...
      <div className={styles.inputsAreaOne}>
        ...
        <InputOne placeHolder={"Ex: samuel@kenzie.com.br"} inputId="email" label="Email" register={register("email")} />
        ...
        <InputOne placeHolder={"00000.000"} inputId="cep" label="CEP" register={register("cep")} />
        <p className={styles.errorMessage}>{errors.cep?.message}</p>
        <div className={styles.inputsAreaTwo}>
        <InputTwo placeHolder={"Digitar Estado"} inputId="estado" label="Estado" register={register("state")}/>
        <p className={styles.errorMessage}>{errors.state?.message}</p>
        <InputTwo placeHolder={"Digitar cidade"} inputId="cidade" label="Cidade" register={register("city")} />
        <p className={styles.errorMessage}>{errors.city?.message}</p>
        </div>
        <InputOne placeHolder={"Digitar rua"} inputId="rua" label="Rua" register={register("street")} />
        <p className={styles.errorMessage}>{errors.street?.message}</p>
        <div className={styles.inputsAreaTwo}>
        <InputTwo placeHolder={"Digitar número"} inputId="número" label="Número" register={register("number")} />
        <p className={styles.errorMessage}>{errors.number?.message}</p>
        <InputTwo placeHolder={"Ex: apart 307"} inputId="complemento" label="Complemento"  register={register("complement")}/>
        ...
        <InputOne placeHolder={"Digitar senha"} inputId="confirmar" label="Confirmar Senha" register={register("passwordConfirmation")} />
