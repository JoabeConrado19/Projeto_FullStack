    ...
    <ModalBase modalTitle="Esqueceu sua senha?" closeModal={closeModalFunc}>
      <div className={styles.modal_body}>
        <p className="body-2-500">
          Caso tenha esquecido sua senha, preencha o campo abaixo e verifique
          sua caixa de entrada do email para redefinir sua senha
        </p>
        <form
        ...
        >
          ...
          />
          <div className={styles.button_container}><ButtonComponent type="submit" className={buttonStyle.brand1_white_button}>Recuperar senha</ButtonComponent></div>
        </form>
      </div>
    </ModalBase>
  );
